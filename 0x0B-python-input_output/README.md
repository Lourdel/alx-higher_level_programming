# Input/Output
Project done during **Full Stack Software Engineering studies** at **ALX AFRICA**. The purpose is to learn how to open, read, write and append files from a script in **Python**.

## Technologies
* Python Scripts are written with Python 3.8.5
* Tested on Ubuntu 20.04 LTS
* Scripts are written to conform to the pycodestyle(version 2.8.)
